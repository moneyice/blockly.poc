...
Blockly.bindEventWithChecks_ = function (node, name, thisObject, func,
  ...
  // console.log(node+'1', name+'2', thisObject+'3', func+'4',opt_noCaptureIdentifier+'5',opt_noPreventDefault+'6');
  // console.log('触发', contsa);
  // contsa++
  var handled = false;
  ...
  // console.log(wrapFunc, '呵呵', contsb);
  // contsb++
  var bindData = [];
  ...
  // console.log(bindData[0][1], '嘻嘻', contsc);
  // contsc++
  return bindData;
};
